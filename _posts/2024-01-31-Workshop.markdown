...
Use the provided abstract templates for Word [add link] and Latex[add link]. Abstracts should be submitted through the following OpenReview link: <a href="https://openreview.net/group?id=datascienceafrica.org/DSA/2024/Workshop">https://openreview.net/group?id=datascienceafrica.org/DSA/2024/Workshop</a> 
